...
1. **Delta time** — fix this now before bad habits set in, it's a small change
2. **Basic collision** — Raycaster? Suddenly the world feels solid
3. **Imported geometry** — load a real city to fly through
4. **Textures** — big visual payoff for low complexity
5. **Shadows** — makes everything look dramatically more real
6. **Shooting** — the fun begins - maybe more like "water bucket"
7. **Enemies** — the game begins - maybe more like "citizens"
